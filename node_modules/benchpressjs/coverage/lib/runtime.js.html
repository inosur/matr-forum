...
<html lang="en">
<head>
    <title>Code coverage report for lib/runtime.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> runtime.js
    </h1>
    <div class='clearfix'>
...
<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof Promise.try !== 'function') {
  Promise.try = {
    try(fn) {
