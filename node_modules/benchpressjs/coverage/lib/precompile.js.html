...
<html lang="en">
<head>
    <title>Code coverage report for lib/precompile.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> precompile.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (result.error) {
<span class="cstat-no" title="statement not covered" >    throw result.error;</span>
  }
&nbsp;
  return result.code;
}
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof source !== 'string') {
<span class="cstat-no" title="statement not covered" >      throw Error('source must be a string');</span>
    }
&nbsp;
...
<span class="fstat-no" title="function not covered" >      err =&gt; <span class="cstat-no" title="statement not covered" ></span>process.nextTick(callback, err),</span>
    );
  }
&nbsp;
  return promise;
