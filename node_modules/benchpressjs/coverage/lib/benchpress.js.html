...
<html lang="en">
<head>
    <title>Code coverage report for lib/benchpress.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> benchpress.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
/** @exports Benchpress */
const Benchpress = (typeof module === 'object' &amp;&amp; module.exports) ? module.exports : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
 ...
 */
Benchpress.setGlobal = function <span class="fstat-no" title="function not covered" >setGlobal(key, value) {</span>
<span class="cstat-no" title="statement not covered" >  Benchpress.globals[key] = value;</span>
};
&nbsp;
const assign = Object.assign || <span class="branch-1 cbranch-no" title="branch not covered" >jQuery.extend; // eslint-disable-line</span>
&nbsp;
/**
 * @private
 */
 ...
 */
Benchpress.flush = function <span class="fstat-no" title="function not covered" >flush() {</span>
<span class="cstat-no" title="statement not covered" >  Benchpress.cache = {};</span>
};
&nbsp;
...
function load(template) {
  return new Promise((resolve, reject) =&gt; {
    const promise = Benchpress.loader(template, (<span class="fstat-no" title="function not covered" >templateFunction) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      resolve(templateFunction);</span>
    });
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (promise &amp;&amp; promise.then) {
...
function render(template, data, block) {
  data = Benchpress.addGlobals(data || <span class="branch-1 cbranch-no" title="branch not covered" >{});</span>
&nbsp;
  return Promise.try(() =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!templateFunction) {
<span class="cstat-no" title="statement not covered" >      return '';</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw TypeError('Invalid Arguments: callback must be a function');</span>
  }
...
<span class="fstat-no" title="function not covered" >    err =&gt; <span class="cstat-no" title="statement not covered" ></span>console.error(err), // eslint-disable-line no-console</span>
  );
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Jun 18 2018 19:13:41 GMT-0600 (MDT)
</div>
</div>
