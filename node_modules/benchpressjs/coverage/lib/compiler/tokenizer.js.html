...
<html lang="en">
<head>
    <title>Code coverage report for lib/compiler/tokenizer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/compiler</a> tokenizer.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">100x</span>
<span class="cline-any cline-yes">5749x</span>
<span class="cline-any cline-yes">5749x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5749x</span>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5744x</span>
<span class="cline-any cline-yes">624x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">624x</span>
<span class="cline-any cline-yes">624x</span>
<span class="cline-any cline-yes">481x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">624x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">624x</span>
<span class="cline-any cline-yes">624x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5120x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">100x</span>
<span class="cline-any cline-yes">100x</span>
        ...
        if (matches &amp;&amp; matches[1] !== expectedSubject) {
          ...
          for (let i = index + 1; i &lt; output.length; i += 1) {
            ...
            if (tok.tokenType === 'Close') {
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>if (m &amp;&amp; m[1] === expectedSubject) {
                // found one ahead, so remove the current one
<span class="cstat-no" title="statement not covered" >                remove.add(token);</span>
