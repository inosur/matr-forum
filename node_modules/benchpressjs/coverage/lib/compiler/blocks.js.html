...
<html lang="en">
<head>
    <title>Code coverage report for lib/compiler/blocks.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/compiler</a> blocks.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  return ast.map((node) =&gt; {
    ...
    if (t.isConditionalExpression(node)) {
      ...
      ] : <span class="branch-1 cbranch-no" title="branch not covered" >getBlocks(node.consequent);</span>
    }
