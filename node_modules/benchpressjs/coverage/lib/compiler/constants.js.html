...
<html lang="en">
<head>
    <title>Code coverage report for lib/compiler/constants.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/compiler</a> constants.js
    </h1>
    <div class='clearfix'>
...
const LENGTH_I = <span class="fstat-no" title="function not covered" >i =&gt; <span class="cstat-no" title="statement not covered" ></span>t.identifier(`length${i}`);</span>
&nbsp;
const runtimeParams = [
  HELPERS,
  CONTEXT,
