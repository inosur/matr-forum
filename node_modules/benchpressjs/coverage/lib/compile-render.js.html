...
<html lang="en">
<head>
    <title>Code coverage report for lib/compile-render.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> compile-render.js
    </h1>
    <div class='clearfix'>
...
function compileParse(templateSource, block, data, callback) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!templateSource) {
